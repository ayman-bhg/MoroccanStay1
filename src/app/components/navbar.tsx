        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center gap-8">
            ...
            <Link 
              to="/guide" 
              viewTransition
              className={`font-medium transition-colors ${isActive('/guide') ? 'text-[#2563EB]' : 'text-gray-600 hover:text-gray-900'}`}
            >
              Tourist Guides
            </Link>
            <Link 
              to="/admin" 
              viewTransition
              className={`font-medium transition-colors ${isActive('/admin') ? 'text-[#2563EB]' : 'text-gray-600 hover:text-gray-900'}`}
            >
              Admin
            </Link>
          </div>
