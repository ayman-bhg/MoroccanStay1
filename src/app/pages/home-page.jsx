    ...
    return (<div className="min-h-screen bg-gray-50">
              ...
              <div className="grid grid-cols-4 gap-4">
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    ...
                    <Input type="text" placeholder="Where to?" value={city} onChange={(e) => setCity(e.target.value)} className="pl-11 h-14 rounded-xl border-gray-300 bg-gray-50 text-black placeholder:text-gray-500"/>
                  </div>
                </div>
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    ...
                    <Input type="date" value={checkIn} onChange={(e) => setCheckIn(e.target.value)} className="pl-11 h-14 rounded-xl border-gray-300 bg-gray-50 text-black"/>
                  </div>
                </div>
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    <Calendar className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400"/>
                    <Input type="date" value={checkOut} onChange={(e) => setCheckOut(e.target.value)} className="pl-11 h-14 rounded-xl border-gray-300 bg-gray-50 text-black"/>
                  </div>
                </div>
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    ...
                    <Input type="number" placeholder="2" value={guests} onChange={(e) => setGuests(e.target.value)} className="pl-11 h-14 rounded-xl border-gray-300 bg-gray-50 text-black placeholder:text-gray-500" min="1"/>
                  </div>
                </div>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-8 py-16">
        ...
        <div className="grid grid-cols-3 gap-8">
          {hotels.map((hotel) => (<div key={hotel.id} className="bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300">
