...
import { LayoutDashboard, Hotel, MapPin, FileText, LogOut, DollarSign, TrendingUp, Users, Calendar, Pencil } from "lucide-react";
                ...
                prev.map(h =>
                    h.id === editingHotel.id
                        ? {
                            ...
                            rooms: Number(hotelForm.rooms) || h.rooms || 0,
                            rating: Number(hotelForm.rating) || h.rating || 0,
                        }
                        : h
                )
            );
            ...
            <div className="space-y-10">
              <div className="grid grid-cols-4 gap-6 animate-[pageFade_220ms_ease-out]">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md p-6">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-1">{hotelList.length}</h3>
              ...
              <div className="bg-white rounded-2xl shadow-md overflow-hidden border border-gray-100">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y divide-gray-200">
                      {guideList.map((g) => (<tr key={g.id} className="hover:bg-gray-50">
        ...
        <DialogContent className="max-w-md rounded-2xl">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input id="guide-city" placeholder="Marrakech, Fés..." value={guideForm.city} onChange={(e) => setGuideForm({ ...guideForm, city: e.target.value })} className="rounded-lg mt-1"/>
            </div>
            <div>
